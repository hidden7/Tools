...
{
    public class Config : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public Config()
        {
            ...
            selectedSceneNodeView = new SceneNodeView( new SceneNode { id = string.Empty, locationX = string.Empty, locationY = string.Empty, locationZ = string.Empty,
